...
export default function Sidebar({ open, onClose, onLogout }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-surface-900 text-white transform transition-transform duration-200 ease-in-out ${
          open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        }`}
      >
        <div className="flex flex-col h-full">
          <div className="px-6 py-5 border-b border-surface-700">
            <h2 className="text-xl font-semibold">Report Room</h2>
